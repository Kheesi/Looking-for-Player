...
<html>
 ...
 <?php   if(!isset($_SESSION['utilisateur'])){
              ...
              echo      "<div id=\"formulaire_cv_equipe\">
                        <form action=\"Traitement_formulaire_equipe.php\" method=\"post\">
                         <h2>Créez votre annonce</h2>
                         <p><input class=\"form-control\" type=\"text\" placeholder=\"Titre de l'annonce\" name=\"titre\"></p>
                         <p><input class=\"form-control\" type=\"text\" placeholder=\"Nom de l'équipe\" name=\"pseudo\"></p>
                   
                        <p class=\"text\"> Serveur:</p>
                        <p><select name=\"serveur\">
